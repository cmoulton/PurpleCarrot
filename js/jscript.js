 ...
 (function(){
 	var result = false,
 		...
 		if(MobilePattern.test(browser)){
 			...
 			document.getElementsByTagName("head")[0].innerHTML += "<link rel=\"stylesheet\" type=\"text/css\" href=\"css/mobile-style.css\" />";
 		}
 
 }());

$.ajax({
    url: 'commons/header.html',
